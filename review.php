        ...
        <div class="my-auto">
            <form id="review-form" action="includes/review-helper.php" method="post">
                ...
                <div class="form-group" style="margin-top: 15px;">
                    <label class="table-label" for="review-title" style="font-size: 16px; font-weight: bold;">Title</label>
                    <input class="text" name="review-title" id="review-title" style="width: 100%; margin-bottom: 10pc;">
